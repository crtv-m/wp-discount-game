      ...
      <script>
        (function() {
              ...
              update: function() {
                ...
                if (this.playing) {
                  ...
                  if (!collision) {
                    ...
                    this.gameOver();/*чувствовать перпятствия*/
                  }
          ...
          function quadraticFunction(x) {
            var b = 0.0010;
            var maxAmplitude = 5; // Задайте желаемую амплитуду
            var y = maxAmplitude * Math.tanh(b * x);// Вычисление y с учетом амплитуды
            return y.toFixed(2);
          }

          console.log("При x=1500, y=" + quadraticFunction(1500));
          function getPriceSale(distance) {
            var element = document.getElementById('sale-title');
            var sale = calculateSale(distance);
            element.innerHTML = 'Cумма вашей скидки - ' + sale + ' %';
          }
